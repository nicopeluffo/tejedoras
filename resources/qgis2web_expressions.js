...
function exp_Pases_1rule0_eval_expression(context) {
    // 
...
function exp_Pases_1rule1_eval_expression(context) {
    // Tejedoras = '1'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Tejedoras')  == '1');
    } else {
        return (feature.get('Tejedoras')  == '1');
    }
}
...
function exp_Localidades_3rule1_eval_expression(context) {
    // PAIS = 'Argentina'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PAIS')  == 'Argentina');
    } else {
        return (feature.get('PAIS')  == 'Argentina');
    }
}